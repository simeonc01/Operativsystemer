...
int main(int argc, char *argv[])
{
  ...
  1c:	84850513          	addi	a0,a0,-1976 # 860 <malloc+0xec>
  20:	00000097          	auipc	ra,0x0
  24:	696080e7          	jalr	1686(ra) # 6b6 <printf>
        exit(1);
  28:	4505                	li	a0,1
  2a:	00000097          	auipc	ra,0x0
  2e:	2ec080e7          	jalr	748(ra) # 316 <exit>
  32:	84aa                	mv	s1,a0
  34:	892e                	mv	s2,a1
    }
  ...
  3c:	0b0080e7          	jalr	176(ra) # e8 <strlen>
  40:	02051993          	slli	s3,a0,0x20
  44:	0209d993          	srli	s3,s3,0x20
    int pid = atoi(argv[2]);
  48:	01093503          	ld	a0,16(s2)
  4c:	00000097          	auipc	ra,0x0
  50:	1ca080e7          	jalr	458(ra) # 216 <atoi>
  54:	85aa                	mv	a1,a0

    if (argc == 2) {
  56:	4789                	li	a5,2
  58:	00f48c63          	beq	s1,a5,70 <main+0x70>
        va2pa(va, -1);
        exit(1);
    }
  ...
  62:	370080e7          	jalr	880(ra) # 3ce <va2pa>
    // printf("%d\n", va2pa(0, 0));
    // printf("%d\n", argc);
    exit(0);
  66:	4501                	li	a0,0
  68:	00000097          	auipc	ra,0x0
  6c:	2ae080e7          	jalr	686(ra) # 316 <exit>
        va2pa(va, -1);
  70:	55fd                	li	a1,-1
  72:	854e                	mv	a0,s3
  74:	00000097          	auipc	ra,0x0
  78:	35a080e7          	jalr	858(ra) # 3ce <va2pa>
        exit(1);
  7c:	4505                	li	a0,1
  7e:	00000097          	auipc	ra,0x0
  82:	298080e7          	jalr	664(ra) # 316 <exit>
...
malloc(uint nbytes)
{
 ...
 84c:	b56080e7          	jalr	-1194(ra) # 39e <sbrk>
  if(p == (char*)-1)
